...
# Módulo Contratos
router.register(r'entidades-eps',          views.EntidadEPSViewSet)
router.register(r'entidades-afp',          views.EntidadAFPViewSet)
router.register(r'entidades-arl',          views.EntidadARLViewSet)
router.register(r'cajas-compensacion',     views.CajaCompensacionViewSet)
router.register(r'contratos',              views.ContratoViewSet)
router.register(r'afiliaciones-ss',        views.AfiliacionSeguridadSocialViewSet)
router.register(r'contratos-renovaciones', views.ContratoRenovacionViewSet)
