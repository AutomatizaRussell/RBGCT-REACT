                  ...
                  {item.archivo_url && (
                    <div className="flex gap-2 mb-4">
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white text-xs font-semibold rounded-lg hover:bg-indigo-700 transition-colors disabled:opacity-60"
                      >
