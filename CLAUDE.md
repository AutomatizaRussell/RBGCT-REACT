...
- **Causa raíz de 504s intermitentes (resuelta jun 2026):** los servicios quedan en DOS redes (la interna del compose y la de ingreso de Coolify); Traefik solo alcanza la de Coolify y puede elegir la IP de la otra → timeout/504. Fijado con `traefik.docker.network=n10dvijz47as7ci0jt97btt2` en nginx. No quitar esa label mientras este sea el identificador de red del recurso.
